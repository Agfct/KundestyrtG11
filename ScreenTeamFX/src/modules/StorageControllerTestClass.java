...
public class StorageControllerTestClass {
	public static void main(String[] args) {
		...
		TimelineModule tlmodule = TimelineModule.getInstance(); 
		...
		TimelineModel tlm1 = new TimelineModel(new ArrayList<TimelineMediaObject>(), 1);
		TimelineModel tlm2 = new TimelineModel(new ArrayList<TimelineMediaObject>(), 2);
		TimelineModel tlm3 = new TimelineModel(new ArrayList<TimelineMediaObject>(), 3);
		tlmodule.addTimeline(tlm1);
		tlmodule.addTimeline(tlm2);
		tlmodule.addTimeline(tlm3);
		...
		sc.setMediaObjects(mediaobjects);
		sc.setTimelineModule(tlmodule);
		System.out.println("Result success = " + sc.storeSession(tlmodule, savefile));
		
		sc.loadSession(savefile);
